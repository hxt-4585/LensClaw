...
from lensclaw.core.context import AgentState
...
class TestAgent(unittest.TestCase):
    ...
    @patch('lensclaw.core.provider.get_provider')
    @patch('lensclaw.core.skill_loader.load_dynamic_skills')
    @patch('lensclaw.core.tools.builtins.BUILTIN_TOOLS', [])
